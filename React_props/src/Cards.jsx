function card({ heading, messgae }) {
  return (
    <>
      <div class="w-64 bg-white shadow-[0px_0px_15px_rgba(0,0,0,0.09)] p-9 space-y-3 relative overflow-hidden m-8 ">
        ...
        <p class="text-sm text-zinc-500 leading-6">{messgae}</p>
      </div>
    </>
  );
}
