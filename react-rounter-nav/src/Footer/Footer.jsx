            ...
            <div className="-mx-4 flex flex-wrap justify-between">
              <div className="px-4 my-4 w-full xl:w-1/5">
                ...
                <p className="text-justify">
                  ...
                  Itaque sunt eveniet, vero sed neque illum consequatur expedita
                  animi molestiae. Necessitatibus earum, facilis tempora ad esse
                  explicabo labore, assumenda omnis qui sed magni sequi
                  voluptatem inventore voluptates nostrum velit facere vero
                  natus? Laborum vitae sunt perferendis veniam ipsa porro
                  facilis nisi.
                </p>
              </div>
